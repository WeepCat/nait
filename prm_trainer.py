...
class ProcessRewardModelTrainer(ABC):
    ...
    def __init__(
        ...
        self.loss_fn = PRMLoss(self.placeholder_token_id, self.reward_token_ids, pos_neg_ratio=pos_neg_ratio)
...
class ProcessRewardModelWithHardLabelTrainer(ABC):
    """
    Trainer for training a process reward model.
...
# class ProcessRewardModelWithSoftLabelTrainer(ABC):
#     """
#     Trainer for training a process reward model.
