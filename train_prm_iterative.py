...
def train(args, train_data_override=None):
    # configure strategy
    ...
    if train_data_override is None:
    ...
    train_dataset = ProcessRewardDataset(train_data, tokenizer, args.train_max_len, strategy)
    ...
    if getattr(args, "eval_dataset", None):
        ...
        eval_dataset = ProcessRewardDataset(eval_data, tokenizer, args.eval_max_len, strategy)
...
#     # Checkpoint
#     parser.add_argument("--save_path", type=str, default="./checkpoint/mistal-7b-prm")
...
#     # PRM training
#     parser.add_argument("--pretrain", type=str, default="mistralai/Mistral-7B-v0.1")
...
#     parser.add_argument("--train_batch_size", type=int, default=1, help="Global training batch size")
...
#     # custom dataset
#     parser.add_argument("--dataset", type=str, default="zhuzilin/Math-Shepherd", help="Path to the training dataset")
...
#     parser.add_argument("--label_key", type=str, default="value", help="JSON dataset key")
#     parser.add_argument("--max_len", type=int, default=256, help="Max tokens for the samples")
